...
export function ProfileMenu() {
  ...
  return (
    <>
      <style>{`@media (min-width: 1024px) { header.z-\\[3000px\\] { padding-right: 4.75rem !important; } header.z-\\[3000px\\] > div:nth-child(2) { flex: 0 1 min(44vw, 560px) !important; max-width: min(44vw, 560px) !important; } }`}</style>
      <div ref={panelRef} data-profile-menu className="fixed right-2.5 top-2.5 z-[9999] lg:right-3 lg:top-3">
