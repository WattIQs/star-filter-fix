...
export function MobileActions() {
  ...
  return (
    <div className="fixed inset-x-3 bottom-3 z-[4000] flex items-center gap-2 rounded-2xl border border-border/70 bg-card/95 p-2 shadow-2xl backdrop-blur-xl lg:hidden">
      <div className="min-w-0 flex-1"><ExportCsvButton /></div>
