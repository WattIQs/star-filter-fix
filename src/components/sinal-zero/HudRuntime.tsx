...
export function HudRuntime() {
  useEffect(() => {
    ...
    style.textContent = `
      ...
      @keyframes sz-target-spin{from{transform:rotate(0deg)}to{transform:rotate(360deg)}}
      ...
      @media(prefers-reduced-motion:reduce){.loading-state-enter::before,.loading-state-enter::after,.loading-state-spinner{animation:none!important}.loading-state-spinner{opacity:1!important;transform:none!important}}
    `;
